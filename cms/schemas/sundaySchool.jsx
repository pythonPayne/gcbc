export default {
  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        list: [          
          {title: 'Darrell Cook', value: 'Darrell Cook'},
          {title: 'David Wickiser', value: 'David Wickiser'},
          {title: 'Dustin Curtis', value: 'Dustin Curtis'},
          {title: 'Ed Wallen', value: 'Ed Wallen'},
          {title: 'Jayson Faulkner', value: 'Jayson Faulkner'},
          {title: 'Louie Davis', value: 'Louie Davis'},
          {title: 'Matt Carver', value: 'Matt Carver'},
          {title: 'Matt Posey', value: 'Matt Posey'},
          {title: 'Michael Gaydosh', value: 'Michael Gaydosh'},
          {title: 'Richard Hughes', value: 'Richard Hughes'},
          {title: 'Stephen Hyde', value: 'Stephen Hyde'},
          {title: 'Steve Cowan', value: 'Steve Cowan'},
          {title: 'Todd Wilson', value: 'Darrell Cook'},
          {title: 'Wade Potts', value: 'Wade Potts'},
        ],         
      }
    },
    {
