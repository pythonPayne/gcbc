...
const Contact = () => {
  ...
  const sendMessageURL = "https://www.sermonaudio.com/solo/gracecovenantbaptist/contact/send-messsage/"
  ...
  return (
    <Layout>
      <div page={'contact'} className={`${showMenu && "pointer-events-none"} pt-20`}>
