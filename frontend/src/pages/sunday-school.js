                    ...
                    {booksOT.map((book, i) => (
                      <div
                        ...
                        className={`text-center text-sm p-2 border cursor-pointer ${
                          sundayschoolBookFilter === book && "bg-gray-300"
                        }`}
                        onClick={() => {
                          dispatch(
                            setSundayschoolBookFilter(
                    ...
                    {speakers.map((speaker, i) => (
                      <div
                        ...
                        className={`text-sm text-center px-4 py-2 border cursor-pointer ${
                          sundayschoolSpeakerFilter === speaker && "bg-gray-300"
                        }`}
                        onClick={() => {
                          dispatch(
                            setSundayschoolSpeakerFilter(
                              speaker !== sundayschoolSpeakerFilter
                                ? speaker
                                : null
                            )
                          )
              ...
              <div className={`py-8`}>
                <div className={`shadow-md rounded-md mb-2`}>
                  <input
                    ...
                    type="text"
                    value={sundayschoolSearchFilter}
                    placeholder={"Search lessons..."}
                    onChange={(e) =>
                      dispatch(setSundayschoolSearchFilter(e.target.value))
                    }
                  />
                </div>
                ...
                >
                  <div className={`flex space-x-3`}>
                    <button
                      ...
                      onClick={() =>
                        dispatch(toggleShowSundayschoolFilterMenu(true))
                      }
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className={`text-gray-600`}>
                    ...
                    {filteredSermons.length === 1 ? "lesson" : "lessons"}
                  </div>
                </div>
              </div>
