...
const Sermons = ({data}) => {
  ...
  const sermon_card = (sermon) => {
    return (
        ...
        <div key={sermon._id} className={`bg-white relative grid place-content-center text-center h-[25vh] shadow-md bg-payne`}>
          ...
          <div className={`absolute bottom-0 flex w-full justify-between items-center py-2 px-4`}>
            ...
            <a className={`text-md text-gray-400`} href={testLink} target="_blank">
  ...
  return (
    <Layout>    
      ...
      <div page={'sermons'} className={`min-h-screen bg-gray-100 pb-36 px-8 transition-all ${showMenu ? "blur-sm duration-500" : "blur-none duration-200"}`}>
