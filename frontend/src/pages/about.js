...
const About = () => {
  ...
  return (
    <Layout>
      ...
      <div page={'about'} className={`px-12 pt-6 pb-36 min-h-screen flex flex-col justify-center bg-gray-100 transition-all ${showMenu ? "blur-sm duration-500" : "blur-none duration-200"}`}>
