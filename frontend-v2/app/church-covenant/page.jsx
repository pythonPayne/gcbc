      ...
      <div className={`${showMenu && "pointer-events-none"} pt-20 pb-48 md:pb-96 flex justify-center bg-gray-100`}>
        <div className={`max-w-[1000px]`}>
          <div className={`px-12 md:px-12 pt-12 pb-36 min-h-screen flex flex-col bg-gray-100 transition-all ${showMenu ? "blur-sm duration-500" : "blur-none duration-200"}`}>
            <div className={`text-center font-semibold font-serif text-2xl lg:text-3xl text-[#09314C]`}>Church</div>
            <div className="p-1"></div>
            <div className={`text-center font-semibold font-serif text-2xl lg:text-3xl text-[#09314C]`}>Covenant</div>

            <div className={`pt-10`}>
              <p className={`pb-6 leading-8 text-lg text-justify text-gray-700`}>
